<html>
	...
	<body>
		<div class="container">
			<br />
			<br />
			<h2 align="center"><a href="">Dynamically Add or Remove input fields in PHP with JQuery</a></h2><br />
					...
					<div class="table-responsive">
						<table class="table table-bordered" id="dynamic_field">
							<tr>
								...
								<td><input type="text" name="description" placeholder="Enter Description" class="form-control name_list" /></td> -->
